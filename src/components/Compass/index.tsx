  ...
  <div className="compass">
   <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 331 331">
    <g fill="none" fill-rule="evenodd" opacity=".401">
     ...
     <path stroke="#000" stroke-linecap="square" stroke-linejoin="bevel" stroke-width="2" d="m11.421 250 .158 17.999" transform="translate(154 31)" />
   ...
   <svg id="arrowSVG" style={{ transform: `rotate(${windDirection}deg)` }} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 331 331">
   ...
   <div className="compass-content">
    <span x-text="windSpeed">{getWindDirection(windDirection)}</span>
   </div>
  </div>
 );
};
